...
export const metadata: Metadata = {
  title: "APPortal Uploads :: Our Case Studies",
  description:
    "Explore how APPortal Uploads helps businesses streamline operations, improve efficiency, and stay compliant.",
};
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {caseStudies.map((study) => (
            <div
              key={study.slug}
              className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:scale-[1.02] transition transform"
            >
              <div className="w-full h-56 relative">
                <Image
                  src={study.imageUrl}
